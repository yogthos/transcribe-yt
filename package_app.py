#!/usr/bin/env python3
"""
Script to package the Transcribe YouTube GUI into a macOS .app bundle
"""
...
# Add the app bundle's bin directory to PATH for ffmpeg
...
"""
    ...
    print(f"  zip -r {app_name}.zip {app_name}.app")

    return True

def create_app_icon(resources_path):
    """Create a simple app icon"""
    # Create a simple text-based icon as placeholder
    icon_content = """# Transcribe YouTube App Icon
# This is a placeholder icon
# Replace with actual .icns file for production
"""

    with open(f"{resources_path}/icon.txt", "w") as f:
        f.write(icon_content)

def main():
    """Main packaging function"""
    print("Transcribe YouTube - macOS App Bundle Creator")
    print("=" * 50)
